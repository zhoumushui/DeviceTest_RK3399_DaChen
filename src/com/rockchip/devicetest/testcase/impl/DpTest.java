...
public class DpTest extends BaseTestCase {
	...
	public DpTest(Context context, Handler handler, TestCaseInfo testcase) {
	...
	public boolean onTesting() {
		...
		builder.setTitle(R.string.dp_title);
		builder.setMessage(R.string.dp_msg);
		/*
