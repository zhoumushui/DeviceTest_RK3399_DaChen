...
public class WifiSmbTest extends BaseTestCase {
	private static final String TAG = "WifiSmbTest";
	...
	public WifiSmbTest(Context context, Handler handler, TestCaseInfo testcase) {
	...
	public boolean onTesting() {
		...
		builder.setTitle(R.string.smb_wifi_title);
	...
	private Runnable checkRunnable = new Runnable() {
		...
		public void run() {
			retry_count++;
			if(IperfUtils.isNetworkConnected(mContext) && IperfUtils.isWifi(mContext))//以太网已连接
			{
				if(mUpdateUIThread == null)
				{
