...
public class SpdifTest extends BaseTestCase {
	...
	public SpdifTest(Context context, Handler handler, TestCaseInfo testcase) {
	...
	public boolean onTesting() {
		...
		builder.setTitle(R.string.spdif_title);
		// builder.setView(view);
		builder.setSingleChoiceItems(R.array.test_spdif, 0,
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				rightEnable = true;
				if (mPlayer != null)
					mPlayer.setVolume(leftEnable ? 1 : 0,
							rightEnable ? 1 : 0);
			}
		});
	...
	private void startPlay() {
		...
		String mVolume = attachParams.get(ParamConstants.SPDIF_TEST_VOLUME_PERCENT);
