...
public class FanTest2 extends BaseTestCase {
	...
	public FanTest2(Context context, Handler handler, TestCaseInfo testcase) {
		super(context, handler, testcase);
		mLEDHandler = new LEDHandler(handler.getLooper());
	}

	public boolean onTesting() {
		SettingUtil.setFanMode(3);
		
		AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
		builder.setTitle(R.string.fan2_title);
		builder.setMessage(R.string.fan2_msg);
		/*
