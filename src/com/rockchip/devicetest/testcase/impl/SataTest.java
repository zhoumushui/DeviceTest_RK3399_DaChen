...
public class SataTest extends BaseTestCase {
	...
	public SataTest(Context context, Handler handler, TestCaseInfo testcase) {
	...
	public boolean onTesting() {
		...
		builder.setTitle(R.string.sata_title);
		builder.setMessage(R.string.sata_msg);
		/*
