...
public class TestCaseArrayAdapter extends ArrayAdapter<TestCaseInfo> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		listHoder.txtTitle = (TextView) convertView
				.findViewById(R.id.tv_test_title);
		listHoder.txtStatus = (TextView) convertView
				.findViewById(R.id.tv_test_status);
		listHoder.txtResult = (TextView) convertView
				.findViewById(R.id.tv_test_result);
		listHoder.txtSend = (TextView) convertView
				.findViewById(R.id.tv_test_send);
		listHoder.txtDetail = (TextView) convertView
				.findViewById(R.id.tv_test_detail);
		...
		public void update(Context context, TestCaseInfo testInfo) {
			...
			if (result != null) {
				if (result == TestResultType.SUCCESS) {
					...
					// 显示按OK键进行重测
					failStr += "("
							+ context.getString(R.string.pub_retest,
									testInfo.getTestKeychar()) + ")";
