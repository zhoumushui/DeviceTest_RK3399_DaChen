...
public class GpuTest extends BaseAgingTest {
	...
	public void onCreate(Context context, View view) {
		mParentView = (ViewGroup)view.findViewById(R.id.rl_gpu_test_content);
		mGpuUsageText = (TextView)view.findViewById(R.id.tv_gpu_usage);
		
		LinearLayout surfaceContent = new LinearLayout(context);
		mGLSurfaceView1 = new CubeSurfaceView(context);
		mGLSurfaceView2 = new TeapotSurfaceView(context);
